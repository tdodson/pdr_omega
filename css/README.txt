...
To use these stylesheets, rename the files and pdr_omega with the name of your theme.
...
pdr_omega-alpha-default-narrow.css  
...
pdr_omega-alpha-default-normal.css
...
pdr_omega-alpha-default-wide.css
